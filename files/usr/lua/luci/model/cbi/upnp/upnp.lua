...
-- Опция для управления IPv6
ipv6_disable = s:taboption("general", ListValue, "ipv6_disable", translate("IPv6 Support"),
    translate("Enable or disable IPv6 support"))
ipv6_disable.default = "yes"
ipv6_disable:value("no", translate("Enable IPv6 support"))
ipv6_disable:value("yes", translate("Disable IPv6 support"))
